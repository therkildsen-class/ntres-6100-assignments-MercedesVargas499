...
The base URL:
`https://raw.githubusercontent.com/nt246/NTRES-6100-data-science/master/datasets/buoydata/`

The buoy number: `44013`

The file extension: `.csv`

The `na` argument with the same values:
`c("99", "999", "99.00", "999.0")`
...
The object name where data is stored: `buoy_1987`, `buoy_1988`,
`buoy_1989`, `buoy_1990`
...
![](Assignment_8_files/figure-commonmark/unnamed-chunk-15-1.png)
